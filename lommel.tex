...
\begin{equation*} \begin{aligned}
- i \cdot (-i)^{2m+1} \cdot (-1)^m = (-i)^{2m+2} \cdot (-1)^m = 
\left( \frac{1}{i} \right)^{2m+2} \cdot (-1)^m = \\
= (-1)^{m+1} \cdot (-1)^m = -1 \cdot (-1)^{m+1} \cdot (-1)^{m+1} = 
-1 \cdot (1)^{m+1} = -1
\end{aligned}  \end{equation*}
...
\begin{equation*} \begin{aligned}
I_5 = - 
\frac{\sqrt{(c^2t^2 - z^2) - (\rho-R)^2} \sqrt{(\rho+R)^2 - (c^2t^2 - z^2)}}
{\pi \rho (ct+z)}
\end{aligned}  \end{equation*}
