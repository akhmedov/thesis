...
\title{Випромінювання нестаціонарних полів 
	та їх розповсюдження в нелінійному просторі}
...
%\include{intro}
\include{ch1}	% Метод эволюционных уравнений
%\include{ch2}	% Излучение плоскаго диска

%\include{concl}
\include{bib}

\appendix
\include{app3}	% Властивості векторних операторів
\include{app1}	% Свойства функции Бесселя
%\include{app2}	% Свойства функции Ломмеля
