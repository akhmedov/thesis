...
і за кордоном \cite{imp:BaumIN0105}. Сьогодні, спадок минулих досліджень
століття знайшли своє застосування у системах інтернету речей 
\textcolor{red}{[ПОСИЛАННЯ]}, автомобільної індустрії 
\textcolor{red}{[ПОСИЛАННЯ]}, а також медицини \textcolor{red}{[ПОСИЛАННЯ]}.
...
до коаксіального кабелю через балун \cite{imp:BaumSSN0357}. Кожен з перелічних 
...
з рефлекторні антенами показує, що імпульсні характеристики перших мають 
...
метрикою FWHM розглядається в межах від десятків пікосекунд до декількох 
...
емпірично перевірена, через декількох років, \cite{imp:Wu1991}.
...
пошкоджень, як запевнюють автори. Скруглений рупор починається в одному 
...
позамежами розкриву рупора. Як покажемо далі, це не впливає на точність 
...
утворює плаский диск \ref{fig:lira_wu}. Цікавою варіацією цієї антени є заміна 
...
Таким чином відбиття від внутрішньої поверхні лінзи знижується і характеристики 
...
після основного імпульсу. Проте емпіричне дослідженнях 
...
є те, що вони не надають часову залежіть напруженості поля в довільних точках 
...
вплавить всі причинно пов'язані зі спостереженням події. Таким чином наявність 
розв'язання в будь-якій точці спостереження - необхідна умова для врахування 
нелінійних ефектів методом теорії збурень.
...
тільки дві не нульові рівні між собою моди, які зручно записати одним виразом
використовуючи символи Кронекера $ \delta_{m,\pm1} $:
...
часу, тобто застосуємо правило ітерування Лейбніца \cite{imp:Flanders1973}, 
помітивши, що
%
...
просторово-часовиі подій, які причинно не пов'язані з жодним із крайніх точок 
...
саме пласку хвилю очікується побачити на великій відстані від антени.
...
породженого апертурними антенами змінюється лише від напрямку вектору струму, 
коли поведінка за іншими змінними залежить ще і від відстані.
...
симетрії круглого джерела. З іншого боку вплив відставні від джерела на 
...
що збудиться нею, при часовій залежності сигналу у вигляді функції Хевісайда
...
$ \rho $ та при фіксованих значення $ z $ і $ \varphi $.
...
результати чисельного розрахунку там не аналізуємо. Схожий результат було 
...
де вирази магнітного поля також містять поліноми Лягера, що свідчить про 
...
Рунге \textcolor{red}{[ПОСИЛАННЯ]} та квадратурного правила Сімпсона 
\textcolor{red}{[ПОСИЛАННЯ]}. Помічаємо, що після двох врахованих 
...
бачимо, що компонента $ H_z $ починається з затримною відносно компоненти 
...
наслідок процес формування хвилі у вільному просторі з TEM хвилі у рупорі.
...
В роботах Фарадея \textcolor{red}{[ПОСИЛАННЯ]} зустрічається твердження, що 
...
\textcolor{red}{[Борісов],[Хармут]}. Також відмітимо, що форма часової 
...
Також, узагальнимо фізичний смисл областей випромінювання: $ S_1 $ -
...
\begin{table}[ht] \label{tab:meander_shape}
\caption{Імпульсне електричне поле породжене LIRA, яка збуджується 
прямокутним імпульсом тривалістю R}
\centering
\begin{tabular}{cccc}
...
також, врахувати $ \rho \neq 0 $ можна отримати, що $ \tau_0 > 2R/c $ - 
значення тривалості імпульсу, коли накладання буде відсутнє для довільної 
точки спостереження.
...
\begin{figure}
\subfloat[а]{\includegraphics[width = 3in]{gauss1}} 
\subfloat[б]{\includegraphics[width = 3in]{gauss2}}
...
збуджений іншим струмом. Невелика різниці між формами сигналів може легко 
