...
\end{aligned} \end{equation*} }
%
Користуючись властивостями дельта-функції Дірака та функції Гевісайда 
...
В роботах Герца зустрічається твердження, що випромінює не антена, а 
простір довкола неї. Саме це і спостерігається в області електромагнітного 
снаряду - хвиля у хвилеводі перетворюється на хвилю у вільному середовищі, 
яка не може існувати без поздовжньої компоненти ($ H_z \neq 0 $) 
\textcolor{red}{[Хармут]}.

Таким чином, можемо узагальнити твердження Герца для нестаціонарного процесу: 
розповсюдження хвилі у вільному просторі, почнеться тільки тоді, коли 
спостерігач дізнається про те, що розподіл заряду стороннього джерела 
змінюється у часі або у просторі, а до цього, спостерігається той самий 
процес, що і у внутрішньому просторі антени.

Можемо зробити висновок, що для стаціонарного процесу поняття поля і хвилі 
тотожні, коли у часовій області інколи ні: так наприклад область визначення 
електрично поля, що випромінюється пласким диском $ S_1 \cup S_2 \cup S_3 $, 
а для область визначення хвилі лише $ S_2 \cup S_3 $, тобто електромагнітний 
снаряд не можна назвати хвилею, а лише полем.
...
значення $ A_0 $ протягом $ \tau_0 $ за метрикою 10-90 risetime metric у 
вигляді сигмоїдальної функції.

\begin{figure}[h] \begin{center}
\includegraphics[scale=0.9]{ex_sigmoidal}
