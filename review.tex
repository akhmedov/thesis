...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Переваги надширокосмугових радіоелектронних систем}

LIRA + DeepUWB (hopkins)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Сучасна імпульсна радіоелектроніка}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Сучасні методи обробки сигналів}
...
\begin{enumerate}
	...
	\item Sequence classificaion
	\item Sequence forcasting
...
\begin{enumerate}
	\item Object detetion
	\item Object/instance segmention
	\item Image classificaion
	\item Image generation
	\item Image filtering
\end{enumerate}

\subsection{Статичтичні методи}

Чіслові та Аналогові

\subsection{Нейрогенні методи}

Чіслові та Аналогові

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Метод еврлюційних рівнянь}

Матеріальні рівняння середовища
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Побудова модового базису}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Згортка електромагнітного поля по базису}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Еволюційні рівняння}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Інщі методи в часовій області}

\subsection{Перетворення Фуре для переходу до чсової області}

\subsection{Метод вектору Герца}
до чсової області}
