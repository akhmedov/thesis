...
саме пласку хвилю очікується побачити на віликій відстані від антени.
...
звязані між собою. Це також відповідає критеріям дальної зони, яким повинен
задовольняти отриманий розвязок, а тобто симетричність розподілу струму 
відносно $ \varphi $ зберігається, як для ближньої так і для дальної зони,
цим пояснюється фізичний зміст відділення кутової залежності від залежності
від відстані.
...
Схожий результат було отримано методами частотної області в перших 
...
\caption{Поле породжене антеною типу LIRA, що збуджується прямокутним 
імпульсом тривалістю R}
\centering
\begin{tabular}{cccc}
